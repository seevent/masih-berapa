# Graph Report - sparepart  (2026-07-22)

## Corpus Check
- 45 files · ~23,056 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 256 nodes · 409 edges · 22 communities (13 shown, 9 thin omitted)
...
3. `InventoryContextType` - 16 edges
...
8. `SettingsPage()` - 7 edges
9. `MutationType` - 6 edges
10. `xlsx` - 5 edges
...
Cohesion: 0.07
Nodes (29): clsx, core-js, html2canvas, html5-qrcode, jspdf, lucide-react, motion, dependencies (+21 more)
...
### Community 3 - "App.tsx"
Cohesion: 0.13
Nodes (18): xlsx, AppLayout(), HeaderStats(), HeaderStatsProps, Sidebar(), SidebarProps, useInventory(), NotificationProvider() (+10 more)
...
Cohesion: 0.14
Nodes (23): InventoryProvider(), NotificationContext, NotificationContextType, ToastMessage, ToastType, useNotification(), INITIAL_JADWAL_SHIFT, INITIAL_JENIS_PERALATAN (+15 more)
...
### Community 19 - "Project Handoff Document: SSES T2 Sparepart Management ("Masih Berapa")"
Cohesion: 0.22
...
### Community 20 - "Implementation Tickets: Dashboard Manajemen Sparepart"
Cohesion: 0.40
